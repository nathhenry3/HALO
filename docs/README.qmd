...
For more information, refer to the paper: LINK TO PAPER
...
# First, install and load devtools package
install.packages('devtools')
library(devtools)

# Install and load bpos package from GitHub
install_github('nathhenry3/HALO')
library(HALO)

###   CHANGE ABOVE PACKAGE NAME LATER
