...
# ├── R/
#   ├── sim_functions.R
# │ ├── other_R_files.R  # Place your R code files here
# ├── src/
#   │── Cppcode.cpp  # Your C++ model code
# │ └── other_source_files.cpp  # If needed
# ├── man/  # Documentation files generated by Roxygen2
# ├── DESCRIPTION  # Package metadata
# ├── NAMESPACE   # Package namespace file
# ├── inst/
#   │   └── extdata/  # External data or resources (if any)
# ├── tests/  # Test files
# ├── vignettes/  # Optional vignettes or tutorials
# ├── README.md  # Package readme
# ├── LICENSE    # License file (if applicable)
# └── .Rbuildignore  # Files to be ignored during package build